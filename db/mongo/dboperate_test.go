...
//go test -v github.com\zhoupingl\fireflygo\db\mongo -run ^Test_CommonOperate$
...
//go test -v github.com\zhoupingl\fireflygo\db\mongo -bench ^Benchmark_CommonOperate$
...
//go test -v github.com\zhoupingl\fireflygo\db\mongo -bench ^Benchmark_CommonOperatePP$
