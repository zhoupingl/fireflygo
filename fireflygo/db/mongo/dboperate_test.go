...
//go test -v github.com\sc4599\fireflygo\db\mongo -run ^Test_CommonOperate$
...
//go test -v github.com\sc4599\fireflygo\db\mongo -bench ^Benchmark_CommonOperate$
...
//go test -v github.com\sc4599\fireflygo\db\mongo -bench ^Benchmark_CommonOperatePP$
